...
output "mount_target_id" {
  value = var.mount_target_id != "" ? var.mount_target_id : var.existing_fss_id != "" ? data.oci_file_storage_mount_targets.mount_target_by_export_set[0].mount_targets[0].id : (var.add_fss ? module.fss[0].mount_target_id : "")
}
