...
locals {
  ...
  validation_script_https_port_param                     = var.secure_mode ? format("--https_port %s", var.administration_port) : (var.wls_extern_ssl_admin_port != "" ? format("--https_port %s", var.wls_extern_ssl_admin_port) : "")
