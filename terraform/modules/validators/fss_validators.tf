...
locals {
  ...
  validate_missing_mount_target_subnet_id = var.add_fss && var.use_existing_subnets && var.mount_target_subnet_id == "" ? local.validators_msg_map[local.missing_mount_target_subnet_id_msg] : null
