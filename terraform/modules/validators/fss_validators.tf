...
locals {
  ...
  validate_existing_fss_id = var.add_fss && var.existing_fss_id != "" && (var.existing_fss_id != var.fss_id) ? local.validators_msg_map[local.invalid_existing_fss_id_msg] : null
}
