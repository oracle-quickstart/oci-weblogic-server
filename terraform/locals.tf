...
locals {
  ...
  fss_availability_domain      = var.add_fss && local.use_regional_subnet ? var.fss_availability_domain : (!var.add_existing_fss && !var.add_existing_mount_target ? data.oci_core_subnet.mount_target_subnet[0].availability_domain : var.fss_availability_domain)
